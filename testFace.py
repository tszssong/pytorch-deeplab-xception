...
def test(args):
    ...
    with open('/home/ubuntu/zms/data/face/phototest.txt') as fp:
    # with open('/home/ubuntu/zms/data/face/fullval2019.txt') as fp:
        lines = fp.readlines()
        for line in lines:
            start = time.time()
            imgpath = line.strip()
            ...
            cv2.waitKey(1)
            savepath = '/home/ubuntu/zms/data/face/phototestOut3/' + dir_name
